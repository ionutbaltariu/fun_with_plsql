...
ALTER TABLE rooms ADD CONSTRAINTAPPOINTMENT_ID_SEQ rooms_name_un UNIQUE ( name );
...
CREATE OR REPLACE TRIGGER identity_cards_id_TRG 
BEFORE INSERT ON identity_cards 
FOR EACH ROW 
WHEN (NEW.id IS NULL) 
BEGIN
